...
> ("RFC-001 §N" etc.). Those documents were replaced by the RFC-000…009 series
> in `docs/rfcs/` on 2026-07-03; the historical entries are left as written.
...
## Behavioral floor roles (converge-only; RFC-002, RFC-003)
...
- [~] **Conventions contract** — now `docs/rfcs/RFC-009 Conventions Contract.md` (Status: Draft, first enumeration written 2026-07-03). Stays Draft until `baseline.k3s` consumes it and proves it sufficient.
