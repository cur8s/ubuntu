...
## 1. Provider integration restructure (design approved 2026-07-04)
...
## 2. Decide the example catalog deliberately (from the 2026-07-04 product review)
...
## 3. Playbook review (code first, on purpose)
...
## 6. Docs validation (after the code settles, on purpose)
...
## 7. RFC review and approval round
