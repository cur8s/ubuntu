...
It does not enumerate the baseline's contents (RFC-003: Baseline Contents) or define the acceptance gates that verify outcomes (RFC-007: Validation and Acceptance).
